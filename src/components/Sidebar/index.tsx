...
const Sidebar = ({ sidebarOpen, setSidebarOpen }: SidebarProps) => {
  ...
  return (
    ...
    >
      ...
      <div className="no-scrollbar flex flex-col  duration-300 ease-linear overflow-y-auto flex-grow">
      ...
      <div className="my-auto px-4 py-4">
        <ul>
          <li>
            <Link
              href="/upgrade"
              className={`flex items-center text-2xl font-bold justify-center  gap-2.5 rounded-sm px-4 py-2  text-bodydark1 duration-300 ease-in-out hover:bg-graydark dark:hover:bg-meta-4 ${pathname.includes("upgrade") && "bg-graydark dark:bg-meta-4"
                }`}
            >
              Upgrade
            </Link>
